...
from src.core.constants import API_CALL_DELAY_SECONDS, API_RETRY_BACKOFF_SECONDS
from src.core.logger import get_logger

logger = get_logger(__name__)


def _invoke_chat_text(llm: BaseChatModel, user_text: str) -> str:
    """
...
def invoke_with_single_retry(llm: BaseChatModel, user_text: str) -> str:
    ...
    """
    try:
        return _invoke_chat_text(llm, user_text)
